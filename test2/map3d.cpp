...
Map3D::Map3D(int pos_x, int pos_y, int size_x, int size_y, int size_map_x, int size_map_y)\
...
QWidget *Map3D::get_container(){

    return container;
}
void Map3D::render(char *file_texture){
    layerOneSeries->setTextureFile("");
    layerOneSeries->setTextureFile(file_texture);
}
QSurface3DSeries *Map3D::get_QSurface3DSeries(){
